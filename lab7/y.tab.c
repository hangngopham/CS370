...
{
       0,    49,    49,    57,    66,    68,    72,    72,    79,    79,
      79,    87,    96,    98,   102,   107,   114,   119,   123,   125,
     129,   136,   144,   149,   156,   162,   170,   172,   176,   184,
     186,   190,   190,   195,   197,   201,   203,   207,   209,   212,
     214,   216,   218,   220,   222,   224,   226,   230,   237,   248,
     252,   254,   260,   263,   270,   272,   279,   281,   288,   290,
     295,   302,   304,   308,   314,   316,   320,   324,   331,   333,
     344,   354,   358,   362,   367,   374,   380,   384,   386,   390,
     394,   396,   400
};
#endif
...
#line 103 "hw7parser.y"
  ...
  case 15:
/* Line 1792 of yacc.c  */
#line 108 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(2) - (3)].name));
	        if((entry) && (entry->scope==2)) yyerror("parameter already defined\n");
	        (yyval.node) = ast_create_node(AST_PARA, symtbl_install((yyvsp[(2) - (3)].name), (yyvsp[(3) - (3)].node),data_type,2),(yyvsp[(3) - (3)].node),0);
	      }
    break;
...
#line 115 "hw7parser.y"
    {
		...
		(yyval.node) = ast_create_node(AST_ARRAY_DIMS,entry,0,0);
	       }
    break;

  case 17:
/* Line 1792 of yacc.c  */
#line 120 "hw7parser.y"
...
#line 130 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(2) - (2)].name));
                ...
                entry = symtbl_install((yyvsp[(2) - (2)].name), SYMBOL_ID, data_type, current_scope);
                (yyval.node) = 0;
              }
    break;
  ...
  case 21:
/* Line 1792 of yacc.c  */
#line 137 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(2) - (4)].name));
                if ((entry) && (entry->scope==current_scope)) yyerror("variable name already defined\n");
                entry= symtbl_install((yyvsp[(2) - (4)].name), SYMBOL_ID, data_type, current_scope);
	        
                (yyval.node) = ast_create_node(AST_ASSIGN, (entry->data_type)?Float:Int, ast_create_node(AST_ID, entry, 0, 0), (yyvsp[(4) - (4)].node));
              }
    break;

  case 22:
/* Line 1792 of yacc.c  */
#line 145 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(2) - (3)].name));
                if ((entry) && (entry->scope==current_scope)) yyerror("variable name already defined\n");
                (yyval.node) = ast_create_node(AST_ARRAY_DECL, symtbl_install((yyvsp[(2) - (3)].name), (yyvsp[(3) - (3)].node), data_type,current_scope),(yyvsp[(3) - (3)].node), 0);}
    break;

  case 23:
/* Line 1792 of yacc.c  */
#line 150 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(3) - (4)].name));
                if ((entry) && (entry->scope==current_scope)) yyerror("variable name already defined\n");
                entry = symtbl_install((yyvsp[(3) - (4)].name), (yyvsp[(4) - (4)].node), data_type, current_scope);
                (yyval.node) = ast_create_node(AST_LIST,0,(yyvsp[(1) - (4)].node),ast_create_node(AST_ARRAY_DECL,entry,(yyvsp[(4) - (4)].node),0)) ;
             }
    break;

  case 24:
/* Line 1792 of yacc.c  */
#line 157 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(3) - (3)].name));
                if ((entry) && (entry->scope==current_scope)) yyerror("variable name already defined\n");
                entry = symtbl_install((yyvsp[(3) - (3)].name), SYMBOL_ID, data_type, current_scope);
  ...
  case 25:
/* Line 1792 of yacc.c  */
#line 163 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(3) - (5)].name));
                if ((entry) && (entry->scope==current_scope)) yyerror("variable name already defined\n");
                entry= symtbl_install((yyvsp[(3) - (5)].name), SYMBOL_ID, data_type, current_scope);
                (yyval.node) = ast_create_node(AST_LIST, 0, (yyvsp[(1) - (5)].node), ast_create_node(AST_ASSIGN, (entry->data_type)?Float:Int, ast_create_node(AST_ID, entry, 0, 0), (yyvsp[(5) - (5)].node)));
              }
    break;

  case 26:
/* Line 1792 of yacc.c  */
#line 171 "hw7parser.y"
...
#line 173 "hw7parser.y"
  ...
  case 28:
/* Line 1792 of yacc.c  */
#line 177 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(2) - (3)].name));
	       if(!entry) {
	       	     entry = symtbl_install((yyvsp[(2) - (3)].name),SYMBOL_NUM, TYPE_INT,0);
	       }
	       (yyval.entry) = entry; }
    break;
  ...
  case 29:
/* Line 1792 of yacc.c  */
#line 185 "hw7parser.y"
    { data_type = TYPE_INT; }
    break;

  case 30:
/* Line 1792 of yacc.c  */
#line 187 "hw7parser.y"
    { data_type = TYPE_FLOAT; }
    break;

  case 31:
/* Line 1792 of yacc.c  */
#line 190 "hw7parser.y"
    {current_scope++;}
    break;

  case 32:
/* Line 1792 of yacc.c  */
#line 191 "hw7parser.y"
  ...
  case 33:
/* Line 1792 of yacc.c  */
#line 196 "hw7parser.y"
    {  (yyval.node) = (yyvsp[(2) - (3)].node); }
    break;

  case 34:
/* Line 1792 of yacc.c  */
#line 198 "hw7parser.y"
    {  (yyval.node) = 0;  }
    break;

  case 35:
/* Line 1792 of yacc.c  */
#line 202 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 36:
/* Line 1792 of yacc.c  */
#line 204 "hw7parser.y"
    { (yyval.node) = ast_create_node(AST_LIST, 0, (yyvsp[(1) - (2)].node), (yyvsp[(2) - (2)].node)); }
    break;

  case 37:
/* Line 1792 of yacc.c  */
#line 208 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 38:
/* Line 1792 of yacc.c  */
#line 210 "hw7parser.y"
...
#line 231 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(1) - (3)].name));
		...
		if (entry->data_type == TYPE_INT && (yyvsp[(3) - (3)].node)->entry->data_type == TYPE_FLOAT) yyerror("conflict type: float cannot be assigned to integer\n");
                (yyval.node) = ast_create_node(AST_ASSIGN, (entry->data_type)?Float:Int, ast_create_node(AST_ID, entry, 0, 0), (yyvsp[(3) - (3)].node)); 
              }
    break;
...
#line 238 "hw7parser.y"
    { 
		SYMTBL entry = symtbl_lookup((yyvsp[(1) - (4)].name));
	        if (!entry) yyerror("identifier undefined\n");
	        if (entry && (entry->sym_type == SYMBOL_FUNC)) yyerror("identifier is a function name; cannot be assigned a value\n");
		//if (!(entry->ast_link)) yyerror("identifier is not an array\n");
		if (entry->data_type == TYPE_INT && (yyvsp[(4) - (4)].node)->entry->data_type == TYPE_FLOAT) yyerror("conflict type: float cannot be assigned to integer\n");
		//arrayRefChecking($2,entry->ast_link);
		(yyval.node) = ast_create_node(AST_ASSIGN,entry->data_type?Float:Int, ast_create_node(AST_ID,entry,(yyvsp[(2) - (4)].node),0),(yyvsp[(4) - (4)].node));
  ...
  case 49:
/* Line 1792 of yacc.c  */
#line 249 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 50:
/* Line 1792 of yacc.c  */
#line 253 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 51:
/* Line 1792 of yacc.c  */
#line 255 "hw7parser.y"
    { 	
		if(((yyvsp[(1) - (5)].node)->entry->data_type == TYPE_VOID) || ((yyvsp[(3) - (5)].node)->entry->data_type == TYPE_VOID) || ((yyvsp[(5) - (5)].node)->entry->data_type == TYPE_VOID)) yyerror("cond cannot be used for type void\n");
		(yyval.node) = ast_create_node(AST_COND_EXP, ((yyvsp[(3) - (5)].node)->entry->data_type ||(yyvsp[(5) - (5)].node)->entry->data_type)?Float:Int, (yyvsp[(1) - (5)].node), ast_create_node(AST_ALT,((yyvsp[(3) - (5)].node)->entry->data_type ||(yyvsp[(5) - (5)].node)->entry->data_type)?Float:Int, (yyvsp[(3) - (5)].node), (yyvsp[(5) - (5)].node))); }
    break;

  case 52:
/* Line 1792 of yacc.c  */
#line 261 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 53:
/* Line 1792 of yacc.c  */
#line 264 "hw7parser.y"
    { 
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_VOID) || ((yyvsp[(3) - (3)].node)->entry->data_type == TYPE_VOID)) yyerror("|| cannot be used for type void\n");
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_FLOAT)||((yyvsp[(3) - (3)].node)->entry->data_type==TYPE_FLOAT)) yyerror("|| can only be used for integer\n");
		(yyval.node) = ast_create_node(AST_OR, Int, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)) ; }
    break;

  case 54:
/* Line 1792 of yacc.c  */
#line 271 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 55:
/* Line 1792 of yacc.c  */
#line 273 "hw7parser.y"
    {
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_VOID) || ((yyvsp[(3) - (3)].node)->entry->data_type == TYPE_VOID)) yyerror("&& cannot be used for type void\n");
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_FLOAT)||((yyvsp[(3) - (3)].node)->entry->data_type==TYPE_FLOAT)) yyerror("&& can only be used for integer\n");
  ...
  case 56:
/* Line 1792 of yacc.c  */
#line 280 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 57:
/* Line 1792 of yacc.c  */
#line 282 "hw7parser.y"
    { 
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_VOID) || ((yyvsp[(3) - (3)].node)->entry->data_type == TYPE_VOID)) yyerror("== cannot be used for type void\n");
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_FLOAT)||((yyvsp[(3) - (3)].node)->entry->data_type==TYPE_FLOAT)) yyerror("== can only be used for integer\n");
  ...
  case 58:
/* Line 1792 of yacc.c  */
#line 289 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 59:
/* Line 1792 of yacc.c  */
#line 291 "hw7parser.y"
    { 
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_VOID) || ((yyvsp[(3) - (3)].node)->entry->data_type == TYPE_VOID)) yyerror("< cannot be used for type void\n");
		if(((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_FLOAT)||((yyvsp[(3) - (3)].node)->entry->data_type==TYPE_FLOAT)) yyerror("< can only be used for integer\n");
...
(yyval.node) = ast_create_node(AST_GT, Int, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)) ; }
  ...
  case 61:
/* Line 1792 of yacc.c  */
#line 303 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 62:
/* Line 1792 of yacc.c  */
#line 305 "hw7parser.y"
    { 
		if((yyvsp[(1) - (3)].node)->entry->data_type == TYPE_VOID || (yyvsp[(3) - (3)].node)->entry->data_type == TYPE_VOID) yyerror("+ cannot be used for type void\n");
...
#line 309 "hw7parser.y"
  ...
  case 64:
/* Line 1792 of yacc.c  */
#line 315 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 65:
/* Line 1792 of yacc.c  */
#line 317 "hw7parser.y"
    {
	       if(((yyvsp[(1) - (3)].node)->entry->data_type ==TYPE_VOID)||((yyvsp[(3) - (3)].node)->entry->data_type==TYPE_VOID)) yyerror("* cannot be used for type void\n");
...
#line 325 "hw7parser.y"
  ...
  case 68:
/* Line 1792 of yacc.c  */
#line 332 "hw7parser.y"
    { (yyval.node) = (yyvsp[(1) - (1)].node); }
    break;

  case 69:
/* Line 1792 of yacc.c  */
#line 334 "hw7parser.y"
    {
	         if((yyvsp[(2) - (2)].node)->entry->data_type == TYPE_VOID) {
		      yyerror("! cannot be used for type void\n");
	         }
		 if((yyvsp[(2) - (2)].node)->entry->data_type == TYPE_FLOAT) {
  ...
  case 70:
/* Line 1792 of yacc.c  */
#line 345 "hw7parser.y"
    { 
		if((yyvsp[(2) - (2)].node)->entry->data_type == TYPE_VOID) {
		      yyerror("- cannot apply to type void\n");
	         }
...
#line 368 "hw7parser.y"
  ...
  case 75:
/* Line 1792 of yacc.c  */
#line 375 "hw7parser.y"
    { SYMTBL entry = symtbl_lookup((yyvsp[(1) - (2)].name));
	        if(!entry) yyerror("identifier undefined\n");
	        if(entry && (entry->sym_type == SYMBOL_FUNC)) yyerror("identifier is a function name; cannot be assigned a value\n");
	        (yyval.node) = ast_create_node(AST_ARRAY_REF, 0, (yyvsp[(2) - (2)].node),0);
	      }
    break;

  case 76:
/* Line 1792 of yacc.c  */
#line 381 "hw7parser.y"
    { (yyval.node) = (yyvsp[(2) - (3)].node); }
    break;
...
#line 401 "hw7parser.y"
    {
		if((yyvsp[(2) - (3)].node)->entry->data_type != TYPE_INT) {
